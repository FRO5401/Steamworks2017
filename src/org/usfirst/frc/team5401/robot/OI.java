...
*/
		xboxA_Driver.whenPressed(new getServer0());
		xboxB_Driver.whenPressed(new startCapture0());
		xboxX_Driver.whenPressed(new RemoveCapture0());
		xboxY_Driver.whenPressed(new RemoveServer0());
	}
