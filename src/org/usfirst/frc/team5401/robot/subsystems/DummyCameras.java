...
public class DummyCameras extends Subsystem {
	...
	public DummyCameras(){
		...
		backCamera = cameraServer.getInstance().startAutomaticCapture("cam1", 1);//parameters are String, int. Many overloads with different parameters
		backCamera.setResolution(localWidth, localHeight);
		backCamera.setFPS(localFPS);
