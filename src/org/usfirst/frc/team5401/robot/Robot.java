...
//		chooser.addObject("BLUE Hopper Shoot", new AutoBlueHopperAndShoot());
		...
		SmartDashboard.putNumber("DriveStraight P", drivebase.getP());
		SmartDashboard.putNumber("DriveStraight I", drivebase.getI());
		SmartDashboard.putNumber("DriveStraight D", drivebase.getD());
